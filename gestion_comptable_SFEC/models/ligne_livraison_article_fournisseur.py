...
class LigneLivraisonArticleFournisseur(models.Model):
    _name = 'custom_accounting.livraison_article_fournisseur'
    ...
    bon_commande_id = fields.Many2one('custom_accounting.bon_commande_fournisseur', string="Bon de commande lié")
